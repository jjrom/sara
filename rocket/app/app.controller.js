(function () {
    ...
    angular.module('rocket')
            .controller('MainController', ['$rootScope', '$scope', 'restoFeatureAPI', 'rocketServices', 'rocketCart', 'restoUsersAPI', 'rocketCache', MainController]);
    ...
    function MainController($rootScope, $scope, restoFeatureAPI, rocketServices, rocketCart, restoUsersAPI, rocketCache) {
        ...
        vm.addMultipleToCart = function (features, checkLicense, $event) {
            ...
            for (var i = 0, len = features.length; i < len; i++) {
                ...
                if (checkLicense) {
                    restoFeatureAPI.ckeckLicense(feature, function () {
