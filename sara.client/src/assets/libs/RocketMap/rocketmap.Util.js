(function(window) {
    ...
    window.rocketmap.Util = {
         ...
         */
        showMask: function() {
            $('<div id="rocket-mask-overlay"><span class="fa fa-3x fa-refresh fa-spin"></span></div>').appendTo($('body')).css({
                'position': 'fixed',
                'z-index': '100000',
                'top': '0px',
                'left': '0px',
         ...
         * 
         * @param {string} url (e.g. 'http://localhost/rocket/?format=json)
        ...
        /**
         * Set background layer from options
         * 
         * @param {Object} options 
         */
        getBackgroundLayer: function(options) {
            ...
            switch (options.source) {
                case "Bing":
                    source = new window.ol.source.BingMaps(options.options);
                    break;
                case "MapQuest":
