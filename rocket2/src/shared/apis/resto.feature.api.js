...
angular.module('restoFeatureAPIModule',['ngDialog','rocketServicesModule','restoUsersAPIModule'])
        .factory('restoFeatureAPI', restoFeatureAPI);

restoFeatureAPI.$inject = ['ngDialog', 'rocketServices', 'restoUsersAPI'];
