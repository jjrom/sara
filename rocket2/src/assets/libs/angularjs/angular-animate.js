/**
 * @license AngularJS v1.4.0-local+sha.a59dde2
...
var $AnimateCssProvider = ['$animateProvider', function($animateProvider) {
  ...
  this.$get = ['$window', '$$jqLite', '$$AnimateRunner', '$timeout',
    ...
    var bod = getFirstNode($document).body;
...
var $$AnimateCssDriverProvider = ['$$animationProvider', function($$animationProvider) {
  ...
  this.$get = ['$animateCss', '$rootScope', '$$AnimateRunner', '$rootElement', '$document', '$sniffer',
    ...
    var bodyNode = getFirstNode($document).body;
    var rootNode = getFirstNode($rootElement);
    ...
    function prepareAnchoredAnimation(classes, outAnchor, inAnchor) {
      var clone = jqLite(getFirstNode(outAnchor).cloneNode(true));
      ...
      function calculateAnchorStyles(anchor) {
        ...
        var coords = getFirstNode(anchor).getBoundingClientRect();
...
var $$AnimateQueueProvider = ['$animateProvider', function($animateProvider) {
  ...
  this.$get = ['$$rAF', '$rootScope', '$rootElement', '$document', '$$HashMap',
    ...
    function findCallbacks(element, event) {
      var targetNode = getFirstNode(element);
      ...
      $rootScope.$$postDigest(function() {
        ...
        realRunner.done(function(status) {
          ...
          if (animationDetails && animationDetails.counter === counter) {
            clearElementAnimationState(getFirstNode(element));
          }
    ...
    function closeParentClassBasedAnimations(startingElement) {
      var parentNode = getFirstNode(startingElement);
      do {
