...
yum -y install git wget unzip nginx postgresql95-server postgresql95 postgresql95-contrib postgis2_95 postgis2_95-utils postgis2_95-client php php-pgsql php-xml php-fpm python-pip
yum clean all
